...
class HWP:
    ...
    def draw(self, ax: Any) -> None:
        ...
        # Border rectangle (face drawn via gradient image)
    ...
    def to_beam_point(self, point: BeamPoint) -> "HWP":
